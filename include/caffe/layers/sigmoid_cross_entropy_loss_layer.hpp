...
//Sigmoid交叉熵损失层，用于激活层？损失函数？
//比SigmoidLayer + CrossEntropyLaye数值计算稳定性要高，测试阶段本层可直接用SigmoidLayer替换
namespace caffe {
...
class SigmoidCrossEntropyLossLayer : public LossLayer<Dtype> {
 ...
 protected:
  ...
  /// The internal SigmoidLayer used to map predictions to probabilities. SigmoidLayer用于预测概率
  shared_ptr<SigmoidLayer<Dtype> > sigmoid_layer_;
  /// sigmoid_output stores the output of the SigmoidLayer. 存储SigmoidLayer的输出
